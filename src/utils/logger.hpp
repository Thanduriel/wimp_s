...
#		define LOG_LVL0(_message) Jo::Logger::g_logger.Write("Level 0 ", (_message))
#	else
#		define LOG_LVL0(_message) Jo::Logger::g_logger.Write(__FILE__, __FUNCTION__, __LINE__, "Level 0 ", (_message))
#	endif
#else
#	define LOG_LVL0(...)
#endif
...
#if (LOG_LEVEL <= 1)
#	ifdef LOG_NO_LOCALIZATION
#		define LOG_LVL1(_message) Jo::Logger::g_logger.Write("Level 1 ", (_message))
#	else
#		define LOG_LVL1(_message) Jo::Logger::g_logger.Write(__FILE__, __FUNCTION__, __LINE__, "Level 1 ", (_message))
#	endif
#else
#	define LOG_LVL1(...)
#endif
...
#if (LOG_LEVEL <= 2)
#	ifdef LOG_NO_LOCALIZATION
#		define LOG_LVL2(_message) Jo::Logger::g_logger.Write("Level 2 ", (_message))
#	else
#		define LOG_LVL2(_message) Jo::Logger::g_logger.Write(__FILE__, __FUNCTION__, __LINE__, "Level 2 ", (_message))
#	endif
#else
#	define LOG_LVL2(...)
#endif
...
#ifdef LOG_NO_LOCALIZATION
#	define LOG_ERROR(_message) Jo::Logger::g_logger.Write("Error   ", (_message))
#else
#	define LOG_ERROR(_message) Jo::Logger::g_logger.Write(__FILE__, __FUNCTION__, __LINE__, "Error   ", (_message))
#endif

/// \brief Write an error message and than throw an exception with the
///		message string.
#ifdef LOG_NO_LOCALIZATION
#	define LOG_CRITICAL(_message) {Jo::Logger::g_logger.Write("Critical", (_message)); throw (_message);}
#else
#	define LOG_CRITICAL(_message) {Jo::Logger::g_logger.Write(__FILE__, __FUNCTION__, __LINE__, "Critical", (_message)); throw (_message);}
#endif