...
public:
	...
	enum struct FreeRectChoiceHeuristic
	{
	...
	bool Insert(std::vector<std::pair<RectSize, size_t>> rects, std::vector<Rect> &dst, FreeRectChoiceHeuristic method);
...
private:
	...
	void PlaceRect(const Rect &node, size_t index);
